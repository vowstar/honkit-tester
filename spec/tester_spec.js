...
describe(__filename, function() {
  ...
  it('should add local normal plugin and using it during build', function(testDone) {
    tester.builder()
  ...
  it('should add local scoped plugin and using it during build', function(testDone) {
    tester.builder()
    .withContent('This text is {% test %} foobar {% endtest %}')
